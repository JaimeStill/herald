...
//
// Palette lives in theme.typ. Tokens here are values diagrams
// reference for typography, whitespace, stroke thickness, and
// geometry. Edge weight + dash patterns are picked at the point
// of use.
//
// Single universal font via CaskaydiaMono NFP (proportional Nerd
// Font): reads cleanly for prose labels, carries mono identity for
// code-style content, and provides Nerd Font icon glyphs for
// symbology. Hierarchy is expressed through weight + size, never
// font family.
// ==============================================================
