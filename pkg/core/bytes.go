// Package core holds stateless, cross-cutting primitives shared across
// Herald's domains — byte formatting, JSON extraction, bounded concurrency.
// Additions must be stateless and broadly applicable; domain logic belongs
// in its own package.
package core
